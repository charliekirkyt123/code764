...
public class FrmMain : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.btnToggleTask = new System.Windows.Forms.Button();
        ...
        this.tabControl1.Location = new System.Drawing.Point(243, 0);
        this.tabControl1.Name = "tabControl1";
        this.tabControl1.SelectedIndex = 0;
        this.tabControl1.Size = new System.Drawing.Size(973, 496);
        this.tabControl1.TabIndex = 41;
        // 
        // tabPageClients
        // 
        this.tabPageClients.BackColor = System.Drawing.Color.FromArgb(25, 25, 25);
        this.tabPageClients.Controls.Add(this.lstClients);
        this.tabPageClients.Location = new System.Drawing.Point(4, 24);
        this.tabPageClients.Name = "tabPageClients";
        this.tabPageClients.Padding = new System.Windows.Forms.Padding(0);
        this.tabPageClients.Size = new System.Drawing.Size(965, 468);
        this.tabPageClients.TabIndex = 0;
        this.tabPageClients.Text = "Clients";
        this.lstClients.Location = new System.Drawing.Point(0, 0);
        this.lstClients.Size = new System.Drawing.Size(965, 468);
        // 
        // tabPageTasks
        // 
        this.tabPageTasks.BackColor = System.Drawing.Color.FromArgb(25, 25, 25);
        ...
        this.tabPageTasks.Location = new System.Drawing.Point(4, 24);
        this.tabPageTasks.Name = "tabPageTasks";
        this.tabPageTasks.Padding = new System.Windows.Forms.Padding(0);
        this.tabPageTasks.Size = new System.Drawing.Size(965, 468);
        this.tabPageTasks.TabIndex = 1;
        this.tabPageTasks.Text = "Tasks";
        // 
        // lstTasks
        // 
        this.lstTasks.BackColor = System.Drawing.Color.FromArgb(30, 30, 30);
        ...
        this.lstTasks.Size = new System.Drawing.Size(850, 456);
        ...
        // btnAddTask
        // 
        this.btnAddTask.BackColor = System.Drawing.Color.FromArgb(60, 60, 60);
        this.btnAddTask.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
        this.btnAddTask.ForeColor = System.Drawing.Color.White;
        this.btnAddTask.Location = new System.Drawing.Point(862, 6);
        this.btnAddTask.Name = "btnAddTask";
        this.btnAddTask.Size = new System.Drawing.Size(97, 35);
        ...
        // btnEditTask
        // 
        this.btnEditTask.BackColor = System.Drawing.Color.FromArgb(60, 60, 60);
        this.btnEditTask.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
        this.btnEditTask.ForeColor = System.Drawing.Color.White;
        this.btnEditTask.Location = new System.Drawing.Point(862, 47);
        this.btnEditTask.Name = "btnEditTask";
        this.btnEditTask.Size = new System.Drawing.Size(97, 35);
        ...
        // btnDeleteTask
        // 
        this.btnDeleteTask.BackColor = System.Drawing.Color.FromArgb(60, 60, 60);
        this.btnDeleteTask.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
        this.btnDeleteTask.ForeColor = System.Drawing.Color.White;
        this.btnDeleteTask.Location = new System.Drawing.Point(862, 88);
        this.btnDeleteTask.Name = "btnDeleteTask";
        this.btnDeleteTask.Size = new System.Drawing.Size(97, 35);
        ...
        // btnToggleTask
        // 
        this.btnToggleTask.BackColor = System.Drawing.Color.FromArgb(60, 60, 60);
        this.btnToggleTask.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
        this.btnToggleTask.ForeColor = System.Drawing.Color.White;
        this.btnToggleTask.Location = new System.Drawing.Point(862, 129);
        this.btnToggleTask.Name = "btnToggleTask";
        this.btnToggleTask.Size = new System.Drawing.Size(97, 35);
        this.btnToggleTask.TabIndex = 4;
        this.btnToggleTask.Text = "Enable/Disable";
        this.btnToggleTask.UseVisualStyleBackColor = false;
        this.btnToggleTask.Click += new System.EventHandler(this.btnToggleTask_Click);
    ...
    private void AdjustFormLayout()
    {
        ...
        if (lstTasks != null && lstTasks.Columns.Count > 0 && lstTasks.Width > 0)
        {
            int totalWidth = lstTasks.ClientSize.Width;
            int[] taskColumnWidths = { 40, 180, 120, 280, 120, 110 };

            for (int i = 0; i < lstTasks.Columns.Count && i < taskColumnWidths.Length; i++)
            {
                lstTasks.Columns[i].Width = taskColumnWidths[i];
            }
        }
    }
        ...
        try
        {
            ...
            switch (task.ActionType)
            {
                case TaskActionType.ExecuteCommand:
                    client.Send(new DoSendQuickCommand
                    {
                ...
                case TaskActionType.VisitWebsite:
                    client.Send(new DoVisitWebsite
                    {
                ...
                case TaskActionType.SetRegistry:
                    var regParts = task.ActionDetails.Split('|');
                    if (regParts.Length >= 3)
                    {
                        client.Send(new DoSendQuickCommand
                        {
                            Command = $"reg add \"{regParts[0]}\" /v \"{regParts[1]}\" /d \"{regParts[2]}\" /f"
                        });
                    }
                    break;
